...
//        System.out.println(normalized);
        ...
        Log.d("결과",TwitterKoreanProcessorJava.tokensToJavaStringList(tokens)+"");
...
//        System.out.println(TwitterKoreanProcessorJava.tokensToJavaKoreanTokenList(tokens));
        Log.d("결과",TwitterKoreanProcessorJava.tokensToJavaKoreanTokenList(tokens)+"");
...
//        System.out.println(TwitterKoreanProcessorJava.tokensToJavaStringList(stemmed));
        Log.d("결과",TwitterKoreanProcessorJava.tokensToJavaStringList(stemmed)+"");
        // [한국어, 를, 처리, 하다, 예시, 이다, ㅋㅋ, #한국어]
//        System.out.println(TwitterKoreanProcessorJava.tokensToJavaKoreanTokenList(stemmed));
        Log.d("결과",TwitterKoreanProcessorJava.tokensToJavaKoreanTokenList(stemmed)+"");
